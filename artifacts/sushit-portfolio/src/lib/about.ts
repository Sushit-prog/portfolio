export const bio: string[] = [
  ...
  "I don't ship demo-ware. Everything I publish has tests — 40+ on every shipped project, 268 on the largest — and I document my own incidents like postmortems, not marketing copy. If a project doesn't hold up under that bar, I don't publish it.",
];
